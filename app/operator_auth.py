...
_PUBLIC_API_PATHS = (
    ...
    ("POST", re.compile(r"^/v1/customer-projects/[^/]+/product-clarification$")),
    ("POST", re.compile(r"^/v1/customer-projects/[^/]+/confirm-preview$")),
    ("POST", re.compile(r"^/v1/customer-projects/[^/]+/preview-research$")),
    ...
    ("POST", re.compile(r"^/v1/customer-projects/[^/]+/growth-balance/checkout$")),
    ("POST", re.compile(r"^/v1/customer-projects/[^/]+/growth-balance/verify$")),
